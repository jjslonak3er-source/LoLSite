#!/usr/bin/env python3
"""Turn champion_counters.csv into lol-draft/counters.js."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--csv",
        default=r"C:\Users\jjslo\Code\lol-counters\champion_counters.csv",
    )
    parser.add_argument(
        "--champions",
    ...
    parser.add_argument(
        "--out",
        default=r"C:\Users\jjslo\Code\lol-draft\counters.js",
    )
