#!/usr/bin/env python3
"""Turn champion_synergies.csv into lol-draft/synergies.js."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--csv",
        default=r"C:\Users\jjslo\Code\lol-counters\champion_synergies.csv",
    )
    parser.add_argument(
        "--champions",
    ...
    parser.add_argument(
        "--out",
        default=r"C:\Users\jjslo\Code\lol-draft\synergies.js",
    )
    args = parser.parse_args()
    convert(Path(args.csv), Path(args.champions), Path(args.out))
