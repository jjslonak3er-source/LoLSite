...
def main() -> int:
    ...
    parser.add_argument("--tier", default="", help="Blank uses the site default (Emerald+).")
    parser.add_argument("--out", default=str(ROOT / "cache" / "champion_winrates.csv"))
    parser.add_argument("--site", default=str(ROOT / "winrates.js"))
    parser.add_argument("--champions", default=str(ROOT / "champions.js"))
